  ...
  return (
    <div className="space-y-4 bg-background min-h-dvh" dir="rtl">
      ...
      <div className="px-4 space-y-4">
        ...
        {/* Feedback & Open Source Section */}
        <div className="card-elevated p-4 text-center space-y-3">
          <p className="text-sm font-semibold text-foreground">
            {t("common.login") === "Login" ? "Help us improve!" : "עזרו לנו להשתפר!"}
          </p>
          <p className="text-xs text-muted leading-relaxed">
            {t("common.login") === "Login"
              ? "Found a bug? Missing a feature? Have an idea? We'd love to hear!"
          ...
          <div className="pt-2 border-t border-border/50">
            <p className="text-[10px] text-muted mb-1.5">
              {t("common.login") === "Login" ? "Open source — give us a star!" : "קוד פתוח — תנו לנו כוכב!"}
            </p>
            <a
              href="https://github.com/eladjak/bayit-beseder"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#24292f] dark:bg-[#f0f0f0] text-white dark:text-[#24292f] text-xs font-semibold hover:opacity-90 active:scale-95 transition-all"
            >
