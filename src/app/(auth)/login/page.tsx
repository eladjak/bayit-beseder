...
function LoginContent() {
  ...
  async function handleGoogleLogin() {
    ...
    // OAuth redirects the browser - no need to handle success here
  }
        ...
        {showReset ? (
          ...
          <>
            ...
            <button
              ...
              className="w-full py-2.5 border border-border rounded-xl text-sm text-muted hover:text-foreground hover:bg-surface-hover transition-colors"
            >
