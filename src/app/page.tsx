...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "האם זה עובד גם למשפחות, שותפים וילדים?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "בהחלט! בית בסדר מתאים לזוגות, למשפחות עם ילדים, לשותפים לדירה וגם למי שגר לבד. בהרשמה בוחרים את סוג הבית, והאפליקציה מתאימה את עצמה — כולל מצב ידידותי לילדים. כל אחד בבית רואה את חלקו ותורם.",
      },
    },
  ],
};
      ...
      <footer className="border-t border-border py-10 text-center text-xs text-muted bg-surface">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <a href="/contact" className="inline-flex items-center gap-1 text-[10px] font-medium px-2.5 py-1 rounded-full bg-primary/10 text-primary-ink hover:bg-primary/20 transition-colors">נשמח למשוב!</a>
          </div>

          {/* Links grid */}
          <nav aria-label="קישורי אתר" className="flex flex-wrap justify-center gap-x-6 gap-y-2 mb-6 text-xs">
            <Link href="/dashboard" className="text-primary-ink hover:underline">דשבורד</Link>
            <Link href="/login" className="text-primary-ink hover:underline">התחברות</Link>
            <Link href="/tasks" className="text-primary-ink hover:underline">משימות</Link>
            <Link href="/shopping" className="text-primary-ink hover:underline">קניות</Link>
            <Link href="/weekly" className="text-primary-ink hover:underline">שבועי</Link>
            <Link href="/stats" className="text-primary-ink hover:underline">סטטיסטיקות</Link>
            <Link href="/blog" className="text-primary-ink hover:underline">בלוג</Link>
          </nav>
