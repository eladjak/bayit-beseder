  ...
  return [
    {
      id: "morning-reminder",
      title: "בוקר טוב! ☀️",
      body: "הבית ער כבר שעה ומחכה לכם. קפה קודם, אחר כך משימות.",
    ...
    {
      id: "midday-check",
      title: "צהריים, מה המצב? 🏠",
      body: "הבית שאל אותי לשאול אתכם. הוא אומר שהוא בסדר, אבל... אתם יודעים.",
    ...
    },
    {
      id: "evening-summary",
      title: "סיכום היום 🌙",
      body: "יום עוד אחד שהבית שרד. בואו נראה מה עשינו (ומה דחינו למחר).",
    ...
    },
    {
      id: "weekly-sync",
      title: "תכנון שבועי 📋",
      body: "שבוע חדש = הזדמנות חדשה. בואו נחלק משימות לפני שמישהו יגיד ׳אני תמיד עושה הכל׳.",
