...
export function CategoryManager({
  ...
  const startEdit = (cat: ShoppingCategoryRow) => {
    setEditingId(cat.id);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold text-base text-foreground">ניהול קטגוריות</h2>
          <button
            onClick={onClose}
                      ...
                      {ICON_OPTIONS.map((icon) => (
                        <button
                          ...
                          className={`w-8 h-8 rounded-lg text-lg flex items-center justify-center transition-colors ${
                            editIcon === icon ? "bg-primary/10 ring-2 ring-primary" : "bg-surface hover:bg-surface-hover"
                          }`}
                        >
                          {icon}
                        </button>
            ...
            <div className="flex flex-wrap gap-1.5">
              {ICON_OPTIONS.map((icon) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-lg text-lg flex items-center justify-center transition-colors ${
                    newIcon === icon ? "bg-primary/10 ring-2 ring-primary" : "bg-surface hover:bg-surface-hover"
                  }`}
                >
                  {icon}
                </button>
