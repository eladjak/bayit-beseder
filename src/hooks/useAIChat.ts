...
function generateLocalResponse(userText: string): string {
  ...
  if (lower.includes("שבוע") || lower.includes("תכנון") || lower.includes("תכנן")) {
    return "בשמחה! כמה שאלות מהירות: מה רמת האנרגיה שלכם השבוע — רגילה, קלה, או אינטנסיבית? ואם יש ימים עמוסים שכדאי להקל — ספרו לי.\n\nבינתיים, אפשר לגשת ישירות לעמוד התכנון השבועי (/weekly) ולהפעיל את האשף — הוא יחלק את המשימות אוטומטית לפי ימים ואזורי הבית.";
  }
